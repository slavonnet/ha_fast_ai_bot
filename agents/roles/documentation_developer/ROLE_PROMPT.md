# ROLE_PROMPT (Template): documentation_developer

> Source of truth: `agents/roles/documentation_developer/AGENTS.DOCUMENTATION_DEVELOPER.md`.

## Include policy

- Этот prompt не дублирует правила роли.
- Все обязательные правила, ограничения и критерии брать только из:
  - `agents/roles/documentation_developer/AGENTS.DOCUMENTATION_DEVELOPER.md`
  - `agents/rules/*`
  - `agents/state-machine/*`
- Label mapping брать из: `agents/roles/documentation_developer/ISSUE_LABELS_DOCUMENTATION_DEVELOPER.yaml`
...
runtime_context:
  ...
  issue_title: "<title>"
  issue_url: "<url>"
  role_id: "documentation_developer"
  trigger_label: "req_start_documentation_developer"
...
```markdown
### documentation_developer: result
- Decision: <accept|reject>
- Findings:
  - ...
- Required changes:
